    ...
    ================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="dashboard-list-box margin-top-0">
                                ...
                                <ul>
                                    <?php foreach ($unverifiedCompanies as $row) { ?>
                                        <li>
                                            <div class="list-box-listing">
                                                ...
                                                <div class="list-box-listing-content">
                                                    <div class="inner">
                                                        <h3><a href="../job-details?id=<?php echo $row['id']; ?>"><b><?php echo $row['companyName']; ?></b>
                                                            </a></h3>
                                            ...
                                            <div class="buttons-to-right">
                                                <a href="approve-job-post?id=<?php echo $row['id']; ?>" class="button gray"
                                                    onclick="return confirmApproval()"><i class="sl sl-icon-check"></i>
                                                    Approve</a>
                                                <a href="inform-employer?id=<?php echo $row['id']; ?>" class="button gray"
        ...
        <script>
            function confirmDeletion() {
                ...
                var confirmDeletion = confirm("Are you sure you want to deny this company application?");
        ...
        <script>
            function confirmApproval() {
                // Show a confirmation dialog
                var confirmApproval = confirm("Are you sure you want to approve this company application?");
                // Return true if the user confirms, otherwise return false
