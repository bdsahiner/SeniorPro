	...
	================================================== -->
				<div class="dashboard-content">
					...
					<div class="row">
						...
						<div class="col-lg-12 col-md-12">
							...
							SELECT jobs.* 
							FROM jobs 
							INNER JOIN appliedjobs ON jobs.id = appliedjobs.jobId 
							WHERE appliedjobs.userId = ?
						");
								...
								if ($jobData) {
									...
									<a href="../model/cancel-job-application?id=' . $job['id'] . '" class="button gray" onclick="return confirmDeletion()"><i class="sl sl-icon-close"></i> Cancel</a>
									</div>
								</li>';
									}
									...
									echo 'No job posts found for the user.';
								}
								?>
		...
		<script>
			function confirmDeletion() {
				...
				var confirmDeletion = confirm("Are you sure you want to cancel the application for this job?");
